      ...
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-20">
          ...
          <div className="space-y-8 col-span-1 lg:col-span-1">
            ...
            <div className="flex gap-6">
              <a href="https://github.com/fabriciocunhauk" target="_blank" rel="noopener noreferrer" className="text-nebula-blue/40 hover:text-white transition-colors text-xl">
                <FaGithub />
              </a>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] text-nebula-blue/30 uppercase tracking-[2px]">
          ...
          <div className="flex flex-wrap gap-6">
            ...
            <a href="https://api.nasa.gov" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">NASA API Guidelines</a>
          </div>
        </div>
      </Container>
    </footer>
