                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                   ...
                   <div className="p-10 lg:p-16 flex flex-col justify-center space-y-6 bg-gradient-to-br from-white/10 to-transparent">
                      <div className="space-y-3">
                         <p className="text-accent-gold font-Barlow-Condensed tracking-[3px] uppercase text-sm">{featuredNews.news_site}</p>
                         <h2 className="text-4xl md:text-5xl font-Bellefair leading-tight">{featuredNews.title}</h2>
                         <p className="text-nebula-blue font-Barlow text-lg leading-relaxed opacity-80">{featuredNews.summary}</p>
                      </div>
                      <div className="flex items-center gap-6 pt-4">
                         ...
                         <div className="flex items-center gap-2 text-nebula-blue/60 text-sm">
                            <FaRegClock />
                            {new Date(featuredNews.published_at).toLocaleDateString(undefined, { dateStyle: 'long' })}
                         </div>
                      </div>
                   </div>
                </div>
